...
//
  static int dim_num_save = 0;
#pragma omp threadprivate(dim_num_save)
  long long int i;
  bool includ[LOG_MAX];
  static bool initialized = false;
...
#pragma omp threadprivate(lastq)
  long long int m;
  static long long int maxcol;
#pragma omp threadprivate(maxcol)
  long long int newv;
  static long long int poly[DIM_MAX2] =
  {
    ...
    16209,16215,16225,16259,16265,16273,16299,16309,16355,16375,
    16381 };
#pragma omp threadprivate(poly)
  static double recipd;
#pragma omp threadprivate(recipd)
  static long long int seed_save = - 1;
#pragma omp threadprivate(seed_save)
